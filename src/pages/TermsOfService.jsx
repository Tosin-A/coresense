    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <p>
            By accessing and using CoreSense, you accept and agree to be bound
        ...
        <section>
          ...
          <p>
            CoreSense is an AI-powered health and wellness coaching platform
            that provides personalized insights based on your health data. The
            service includes health data analysis, AI coaching features, and
        ...
        <section>
          ...
          <p>
            ...
            and will remain the exclusive property of CoreSense and its
        ...
        <section>
          ...
          <p>
            ...
            including journal entries and personal notes. By submitting content,
            you grant us a non-exclusive, worldwide, royalty-free license to
            use, reproduce, and display such content for the purpose of
        ...
        <section>
          ...
          <p>
            <strong>Important:</strong> CoreSense is not a medical device and is
            not intended to diagnose, treat, cure, or prevent any disease or
            health condition. The AI coaching and recommendations provided are
            for informational and wellness purposes only and should not be
            considered medical advice.
          </p>
          <p>
            Always consult with a qualified healthcare provider before making
            any decisions about your health, medications, or treatment plans.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            that are not owned or controlled by CoreSense. We have no control
        ...
        <section>
          ...
          <p>
            In no event shall CoreSense, nor its directors, employees, partners,
